    ...
    "tools": [
        {
            ...
            "description": {
                "zh": "立即查询一次聊天运行状态（action / user_state / app_state 等）并追加写入 JSONL 文件。",
                "en": "Query chat runtime state (action/user_state/app_state) once and append to JSONL file."
            },
            "parameters": [
...
var ChatRuntimeStateMonitor = (function () {
    ...
    async function monitor_chat_runtime_state(params) {
        ...
        var record = {
            ...
            action: d.aiBehavior || null,
            user_state: d.userState || null,
            app_state: d.applicationState || null,
            tool_name: d.toolName || null,
            is_idle: d.isIdle || false,
        ...
        if (d.errorMessage) {
            record.error = {
                ...
                recoverable: !!d.errorRecoverable,
                retry_attempt: d.retryAttempt || null
            };
        }
